...
namespace WebApplication.Extensions.LocalStorage
{
    public static class LocalStorageExtension
    {
        ...
        public static string GetExpiration(this ISyncLocalStorageService localStorageService)
        {
            return localStorageService.GetItem<string>("expiration");
        }
        public async static Task<string> GetExpiration(this ILocalStorageService localStorageService)
        {
            return await localStorageService.GetItemAsync<string>("expiration");
        }
        public static void SetExpiration(this ISyncLocalStorageService localStorageService, DateTime value)
        {
            localStorageService.SetItem("expiration", value);
        }
        public async static Task SetExpiration(this ILocalStorageService localStorageService, DateTime value)
        {
            await localStorageService.SetItemAsync("expiration", value);
        }
        //----------------------------------------------------------------------------------------------
