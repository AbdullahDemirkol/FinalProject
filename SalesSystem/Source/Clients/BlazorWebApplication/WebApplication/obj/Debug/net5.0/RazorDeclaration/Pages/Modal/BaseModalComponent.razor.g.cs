...
#nullable restore
#line 5 "C:\Users\Abdullah\Desktop\Bitirme\SalesSystem\Source\Clients\BlazorWebApplication\WebApplication\Pages\Modal\BaseModalComponent.razor"
    ...
    protected async Task ConfirmedClicked()
    {
        await modalInstance.Close(ModalResult.Ok<string>(""));
    }
    protected async Task CancelClicked()
    {
        await modalInstance.Close(ModalResult.Cancel());
    }
