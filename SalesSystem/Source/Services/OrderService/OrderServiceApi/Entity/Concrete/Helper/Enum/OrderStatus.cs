...
namespace OrderServiceApi.Entity.Concrete.Helper.Enum
{
    public class OrderStatus : BaseEnumeration
    {
        ...
        public static OrderStatus IptalEdildi = new(6, nameof(IptalEdildi).ToLowerInvariant());

        public static IEnumerable<OrderStatus> List()
        {
            return new List<OrderStatus> { IslemeAlinildi, DogrulamaBekleniyor, StokOnaylandi, Odenildi, Gonderildi, IptalEdildi };
        }
